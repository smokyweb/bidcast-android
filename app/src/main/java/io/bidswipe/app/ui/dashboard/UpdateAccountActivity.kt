...
class UpdateAccountActivity : BaseActivity() {
    ...
    private val imageResult = registerForActivityResult(CustomCropImageContract()) { result ->
        if (result.isSuccessful) {
            ...
            if (imagePath != null) {
                bind.userProfile.loadUrl(this, imagePath)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getUserProfileRepo.observe(this) {
            when (it) {
                is Resource.Success -> {
                    ...
                    if (mData != null) setProfileData(mData)
                }
        ...
        App.profileResponse.observe(this) { mData ->
            if (mData == null) {
                bind.loader.isVisible = true
                viewModel.getUserProfile()
            } else {
                setProfileData(mData)
            }
        }
    }

    fun setProfileData(mData: UserProfileResponse.Data) {
