...
class LoginFragment : BaseFragment<AuthViewModel, FragmentLoginBinding>() {
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		bind.privacyPolicy.setHapticClickListener {
			startActivity(Intent(mCtx, MoreActivity::class.java).putExtra("slug", "privacy-policy").putExtra("title", "Privacy Policy"))
		}

		bind.termsOfService.setHapticClickListener {
			startActivity(Intent(mCtx, MoreActivity::class.java).putExtra("slug", "terms-condition").putExtra("title", "Terms & Conditions"))
		}
