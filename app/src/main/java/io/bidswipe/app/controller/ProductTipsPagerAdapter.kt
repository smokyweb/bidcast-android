...
class ProductTipsPagerAdapter (mList: MutableList<String>,val type : String?) : BaseAdapter<String, ProductTipItemBinding>(mList) {
        ...
        with(holder) {
            ...
            when (type) {
                "liveTips" -> {
                    ...
                    tipsList.addAll(
                        listOf(
                            SellModel(R.drawable.ic_video,R.color.secondaryContainer,"Private Rehearsal","Practice in private mode to get comfortable with the platform and learn at your own pace."),
                            SellModel(R.drawable.ic_mic,R.color.tertiaryContainer,"Test Sound & Audio","Check your microphone and speakers to ensure clear communication with your audience."),
                            SellModel(R.drawable.ic_hammer,R.color.successContainer,"Live Auction Practice","Walk through an example auction scenario to familiarize yourself with the process."),
                        )
                    )
                ...
                "bringInBuyers" ->{
                    ...
                    tipsList.addAll(
                        listOf(
                            SellModel(R.drawable.ic_gift,R.color.secondaryContainer,"Referral Program","Share your referral code with friends and earn rewards. Both you and your referred friends get special bonuses on their first purchase."),
                            SellModel(R.drawable.ic_person_outlined,R.color.tertiaryContainer,"Complete Your Profile","A complete profile builds trust with buyers. Add a professional photo, detailed bio, and showcase your expertise in your field."),
                            SellModel(R.drawable.ic_share,R.color.successContainer,"Share Your Shows","Promote your upcoming shows on social media. Use our easy sharing tools to post directly to Instagram, Facebook, and Twitter."),
                        )
                    )
                }
                else -> {
