...
class ExploreAdapter(  val mList: MutableList<GetCategoryResponse.Data?>,val mClicks: RecyclerClicks
...
bind.iconCard.setCardBackgroundColor(item?.color?.toColorInt()?: ContextCompat.getColor(mCtx,R.color.primary))
