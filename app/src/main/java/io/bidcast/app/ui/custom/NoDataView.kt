...
import io.bidcast.app.databinding.NoDataViewBinding
import io.bidcast.app.utils.draw
import io.bidcast.app.utils.styleable

class NoDataView @JvmOverloads constructor(val mCtx : Context , attrs : AttributeSet? = null , defStyleAttr : Int = 0) :
